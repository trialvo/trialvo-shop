...
export default function RichTextPreview({
  ...
  return (
    <div
      className={cn(
        "bg-white text-sm text-gray-800 shadow-theme-xs",
    ...
    >
      <div
        className={cn(
          ...
          "[&_table]:border [&_table]:border-gray-300 dark:[&_table]:border-gray-700",
          "[&_thead_th]:bg-gray-100 dark:[&_thead_th]:bg-gray-900/40",
          "[&_th]:font-semibold [&_th]:text-gray-900 dark:[&_th]:text-gray-100",
          "[&_th]:px-3 [&_th]:py-2",
          "[&_td]:px-3 [&_td]:py-2",
          "[&_th]:border [&_th]:border-gray-300 dark:[&_th]:border-gray-700",
          "[&_td]:border [&_td]:border-gray-300 dark:[&_td]:border-gray-700",
          "[&_tbody_tr:nth-child(even)]:bg-gray-50 dark:[&_tbody_tr:nth-child(even)]:bg-white/[0.03]",
          "[&_td]:align-top",
