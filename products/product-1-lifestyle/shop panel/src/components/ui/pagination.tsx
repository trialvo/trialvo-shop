...
function PaginationContent({ className, ref, ...props }: ComponentProps<"ul"> & { ref?: Ref<HTMLUListElement> }) {
  return <ul ref={ref} className={cn("flex flex-row items-center gap-1", className)} {...props} />;
}

function PaginationItem({ className, ref, ...props }: ComponentProps<"li"> & { ref?: Ref<HTMLLIElement> }) {
