...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Trialvo - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Trialvo - React.js Tailwind CSS Admin Dashboard Template"
      />
