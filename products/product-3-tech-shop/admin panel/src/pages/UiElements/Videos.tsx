...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Trialvo - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Trialvo - React.js Tailwind CSS Admin Dashboard Template"
      />
