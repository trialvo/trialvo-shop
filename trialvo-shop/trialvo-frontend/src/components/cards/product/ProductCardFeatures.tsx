...
/** Quiet feature chips — no carousel, no arrows. */
export function ProductCardFeatures({
  ...
  return (
    <ul className="flex flex-wrap gap-1.5">
      ...
      {extra > 0 ? (
        <li className="inline-flex items-center rounded-md px-2 py-1 text-[11px] font-medium leading-none text-muted-foreground">
          +{extra}
        </li>
      ) : null}
    </ul>
