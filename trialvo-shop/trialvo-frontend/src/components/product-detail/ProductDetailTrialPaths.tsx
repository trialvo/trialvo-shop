...
const COPY = {
  bn: {
    ...
    lead: "ডেমো সাথে সাথে; ডোমেইন ট্রায়ালে অনুমোদনের পর আপনি নিজে ইনস্টলার চালাবেন।",
    step1: "ধাপ ১",
    step2: "ধাপ ২",
    demoPoints: ["শপ + অ্যাডমিন লগইন", "১ মিনিটে", "কার্ড লাগবে না"],
    domainPoints: ["আপনার ডোমেইন ও হোস্টিং", "VPS বা cPanel", "এক-কমান্ড ইনস্টলার"],
  ...
  en: {
    ...
    lead: "The demo is instant; the domain trial is a one-command installer you run after approval.",
    step1: "Step 1",
    step2: "Step 2",
    demoPoints: ["Shop + admin login", "In one minute", "No card needed"],
    domainPoints: ["Your domain & hosting", "VPS or cPanel", "One-command installer"],
