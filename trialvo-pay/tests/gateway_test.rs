/// Trialvo Pay Integration Test: EPS Gateway Structures & Hash Computation
/// Tests the EPS x-hash computation that's critical for gateway authentication

mod gateway_tests {
    use trialvo_pay::crypto::hmac::compute_eps_x_hash;
    ...
    fn service_secret_generation_unique() {
        use trialvo_pay::crypto::hmac::generate_service_secret;
    ...
    fn key_lookup_hash_collision_resistance() {
        use trialvo_pay::crypto::hmac::hash_key_for_lookup;
