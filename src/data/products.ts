...
export const products: Product[] = [
  {
    ...
    demo: {
      adminUrl: 'https://demo-admin.example.com',
      adminUsername: 'admin@demo.com',
      adminPassword: 'demo123',
      shopUrl: 'https://demo-shop.example.com',
      shopUsername: 'user@demo.com',
      shopPassword: 'user123',
    },
    name: {
    ...
    seo: {
      ...
      keywords: {
        bn: ['ইকমার্স ওয়েবসাইট', 'রেডিমেড ইকমার্স', 'এডমিন প্যানেল', 'অনলাইন শপ'],
        en: ['ecommerce website', 'ready-made ecommerce', 'admin panel', 'online shop'],
      },
    },
    isFeatured: true,
    isActive: true,
  ...
  },
  {
    ...
    demo: {
      adminUrl: 'https://fashion-admin.example.com',
      adminUsername: 'admin@demo.com',
      adminPassword: 'demo123',
      shopUrl: 'https://fashion-shop.example.com',
    },
    name: {
  ...
  },
  {
    ...
    demo: {
      adminUrl: 'https://gift-admin.example.com',
      adminUsername: 'admin@demo.com',
      adminPassword: 'demo123',
      shopUrl: 'https://gift-shop.example.com',
    },
    name: {
  ...
  },
  {
    ...
    demo: {
      adminUrl: 'https://accessories-admin.example.com',
      adminUsername: 'admin@demo.com',
      adminPassword: 'demo123',
      shopUrl: 'https://accessories-shop.example.com',
    },
    name: {
      bn: 'একসেসরিজ হাব',
      en: 'Accessories Hub',
  ...
  },
  {
    ...
    demo: {
      adminUrl: 'https://tech-admin.example.com',
      adminUsername: 'admin@demo.com',
      adminPassword: 'demo123',
      shopUrl: 'https://tech-shop.example.com',
    },
    name: {
...
export const getRelatedProducts = (productId: string, category: string): Product[] => {
  return products.filter((p) => p.id !== productId && p.category === category && p.isActive).slice(0, 3);
};
