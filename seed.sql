...
VALUES ('28280023-008f-4307-83de-5e4eabb57562', 'trialvo-shop', 'Trialvo Shop', 'https://shop.trialvo.com/order-success', 'https://shop.trialvo.com/checkout?error=payment_failed', 'https://shop.trialvo.com/checkout?error=payment_cancelled', false, true)
...
-- IPN endpoint (fixed URL to match actual backend route)
INSERT INTO ipn_endpoints (service_id, url, secret)
VALUES ('28280023-008f-4307-83de-5e4eabb57562', 'http://backend:5000/api/payments/ipn', '2119d2d37b84fbbe2f405404818940b70b0729f4cb76ea5b980fff42b242fcd6')
ON CONFLICT DO NOTHING;
