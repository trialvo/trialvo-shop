/// PayVault Integration Test: Customer & Billing Logic
/// Tests phone normalization, email normalization, identity hashing, and IPN retry delays

mod billing_tests {
    use payvault::db::customers::{normalize_phone, normalize_email, compute_identity_hash};
    use payvault::db::ipn::next_retry_delay_seconds;
    ...
    #[test]
    fn email_lowercased() {
        assert_eq!(normalize_email("Admin@PayVault.com"), "admin@payvault.com");
    }
