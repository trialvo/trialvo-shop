-- ═══════════════════════════════════════════════════════════════
-- PayVault — Test E-Commerce Setup Script
-- Run this ONCE after PayVault starts to set up:
...
-- Ensure base URL for PayVault is localhost for testing
...
-- 4. Create an IPN endpoint: http://localhost:3456/webhooks/payvault
