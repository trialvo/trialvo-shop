...
const lifestyleCfg = path.resolve(__dirname, '../../../product 1 life style/deploy/obfuscator.config.js');
const lifestyleScript = path.resolve(__dirname, '../../../product 1 life style/deploy/obfuscate-backend.js');
