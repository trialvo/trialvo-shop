...
export const customerApiHelper = {
    get: (endpoint: string) => customerApi(endpoint),
    post: (endpoint: string, data: unknown) => customerApi(endpoint, { method: 'POST', body: JSON.stringify(data) }),
    put: (endpoint: string, data: unknown) => customerApi(endpoint, { method: 'PUT', body: JSON.stringify(data) }),
    delete: (endpoint: string) => customerApi(endpoint, { method: 'DELETE' }),
};
